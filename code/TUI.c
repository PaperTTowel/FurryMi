...
void bisogeo(){
    printf("¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤\n"), Sleep(20);
    printf("¦¢"), gotoxy(36, 1), printf("ÄÁÅÙÃ÷ °æ°í!"), gotoxy(81, 1), printf("¦¢\n");
    printf("¦§"), printf("¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡"), gotoxy(81, 2), printf("¦©\n"), Sleep(20);
    printf("¦¢"), gotoxy(81, 3), printf("¦¢\n"), Sleep(20);
    printf("¦¢"), gotoxy(81, 4), printf("¦¢\n"), Sleep(20);
    printf("¦¢"), gotoxy(81, 5), printf("¦¢\n"), Sleep(20);
    ...
    printf("¦¦¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¥\n"), Sleep(20);
    gotoxy(2, 4), printf("ÀÌ ¹Ì¿¬½Ã´Â ½Ã°¢Àû Çø¿À¼ºÀÇ Àå¸£¸¦ Æ÷ÇÔÇÕ´Ï´Ù.");
    gotoxy(2, 5), printf("ÃëÇâÀÌ ¸ÂÁö ¾ÊÀ¸½Å ºÐµéÀº °ÔÀÓÀ» Á¾·áÇÏ½Ã¸é µË´Ï´Ù.");
    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 14);
    gotoxy(27, 7), printf("| ¾Æ·¡ Àå¸£°¡ Æ÷ÇÔµË´Ï´Ù |");
    gotoxy(2, 8), printf("¡Þ ÆÛ¸®");
    gotoxy(2, 9), printf("¡Þ ·Î¸®");
    gotoxy(2, 10), printf("¡Þ ÃË¼ö");
    gotoxy(2, 11), printf("¡Þ ¼ö°£, Ãæ°£, ÀÌÁ¾°£");
    gotoxy(2, 12), printf("¡Þ BBW or BBM (Big Beautiful Woman, Big Beautiful Man)");
}
...
void help(){
    ...
    gotoxy(2, 6), printf("½ºÅä¸® ¹× ¼¼°è°ü ±âÈ¹/ÀÛ¼º: 30508 ±èÀ±±â");
    gotoxy(2, 7), printf("Ä³¸¯ÅÍ µðÀÚÀÎ ¹× ¹è°æ ÀÏ·¯½ºÆ®: 30508 ±èÀ±±â");
    gotoxy(2, 8), printf("¸ÞÀÎÈ­¸é ÇÁ·Î±×·¡¹Ö: 30507 ±è¿øÇõ");
    gotoxy(2, 9), printf("ÇÁ·Ñ·Î±× ÇÁ·Î±×·¡¹Ö: 1/3 30507 ±è¿øÇõ | 2/3 30508 ±èÀ±±â | ¸¶¹«¸® 30503 ±è³ë¾Æ");
    gotoxy(2, 10), printf("Ã©ÅÍ1 ÇÁ·Î±×·¡¹Ö: 1/3 30507 ±è¿øÇõ | 2/3 30508 ±èÀ±±â");
    gotoxy(2, 11), printf("Ã©ÅÍ2 ÇÁ·Î±×·¡¹Ö: (¾÷µ¥ÀÌÆ® ¿¹Á¤)");
    gotoxy(2, 12), printf("PPT Á¦ÀÛ ¹× ÄÚµå ÇØ¼®ÈÄ ÁÖ¼® Ç¥½Ã: 30503 ±è³ë¾Æ");
    gotoxy(2, 13), printf("ÁÖ¼® È®ÀÎÈÄ ÄÚµå ÇÐ½À ¹× ¹ßÇ¥: 30730: Á¤°æÁØ");
    gotoxy(2, 15), printf("GitHub ¸®Æ÷ÁöÅä¸®: https://github.com/PaperTTowel/FurryMi");
}