...
void help(){
    ...
    gotoxy(2, 8), printf("ÇÁ·Ñ·Î±× ÇÁ·Î±×·¡¹Ö: 1/3 30507 ±è¿øÇõ | 2/3 30503 ±è³ë¾Æ");
    gotoxy(2, 9), printf("Ã©ÅÍ1 ÇÁ·Î±×·¡¹Ö: 30503 ±è³ë¾Æ");
    gotoxy(2, 10), printf("Ã©ÅÍ2 ÇÁ·Î±×·¡¹Ö: (¾ÆÁ÷ ¾È³ª¿È)");
    gotoxy(2, 11), printf("¹ßÇ¥: 30730: Á¤°æÁØ");
}